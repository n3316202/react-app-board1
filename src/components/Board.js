...
const Board = props => {    
    ...
    useEffect(() => {
        getBoard(props.match.params.bid);
                        ...
                        <div className = "card col-md-6 offset-md-3 offset-md-3">
                            ...
                            <div className = "card-body">
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <input type="text" placeholder="bid" name="bid" className="form-control" 
                                        value={board.bid}
                                        />
                                    </div>
                                    <div className = "form-group">
                                    ...
                                    <div className = "form-group">
                                        <label> 내용  </label>
                                        <textarea placeholder="bcontent" name="bcontent" className="form-control" rows="5"
                                        value={board.bcontent}
                                        onChange={handleInputChange}
                                        />
                                    </div>
                                    <button className="btn btn-success" onClick={updateBoard}>Update</button>
                                    <button className="btn btn-danger"  onClick={initBoard} style={{marginLeft:"10px"}}>Cancel</button>
